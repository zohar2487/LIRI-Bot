...
function concertThis(value) {
    axios.get("https://rest.bandsintown.com/artists" + value + "/events?app_id=coodingbootcamp")
    .then(function(response) {
        for (var i = 0; i < response.data.lenght; i++) {

            var datetime = response.datatime;
  ...
  function spotifySong(value) {
      ...
      .then(function(response) {
          for (var i = 0; i < 5; i++) {
              ...
              "\nPreview Link: " +response.trakcs.items[i].preview_url;
